...
class _HomePageState extends State<HomePage> {
                ...
                child: FutureBuilder<List<String>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasError ||
                      ...
                      return const Center(
                        child: Text('No suggestions found or location denied'),
                      );
                    }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final String locationName =
                            journey.destinations.isNotEmpty
              ...
              SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (docs.isEmpty) {
                      return const Center(
                        child: Text('No journeys to be visited'),
                      );
                    }
  ...
  void _showJourneyDetails(BuildContext context, Journey journey) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            JourneyDetailsPage(existingJourney: journey, isReadOnly: true),
      ),
    );
  }

  //Shows the pop up for the description
  void _showCityDescription(BuildContext context, String cityName) async {
    showDialog(
      context: context,
      barrierDismissible: false,
      //if true, the user could click outside and close the pop up
      builder: (context) => const Center(child: CircularProgressIndicator()),
    );

    String description = await _placesService.getPlaceDescription(cityName);

    // Truncate logic: find the first grammatical period after 50 characters
    if (description.length > 200) {
      // RegExp: a dot NOT followed by a digit (prevents cutting at 2.000)
              ...
              children: [
                Row(
                  children: [
                    ...
                    // Bilancia l'IconButton a destra per centrare il titolo
                    Expanded(
                      child: Text(
                        cityName,
